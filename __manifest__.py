...

{
    ...
    'data': [
        ...
        'views/saleorder_promotions_bluetooth.xml',
        'views/report_saleorder_document_promotions_bluetooth.xml',
        'views/report_saleorder_document_without_promotions_bluetooth.xml',
        'views/delivery_promotions_bluetooth.xml',
        'views/invoice_promotions_bluetooth.xml',
        'views/report_delivery_document_without_promotions_bluetooth.xml',
        'views/report_delivery_document_promotions_bluetooth.xml',
        'views/report_invoice_document_without_promotions_bluetooth.xml',
        'views/report_invoice_document_promotions_bluetooth.xml',
    ],
    'demo': [],
    'installable': True,
    'auto_install': False,
